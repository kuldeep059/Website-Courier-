...
$(function () {
    ...
    (function () {
        if ($("#countdown-timer1").length) {
            $("#countdown-timer1").countdown("2024/03/18", function (event) {
    ...
    function redirectToTrackingPage() {
        // Replace 'tracking-page-url' with the actual URL of your tracking page
...
function animateNumbers() {
    ...
    const speed = 3000; // Adjust the animation speed here
    ...
    counters.forEach(counter => {
        ...
        updateCount();
        counter.classList.add('count-up'); // Add animation class
    });
}
